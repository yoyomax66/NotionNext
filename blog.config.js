...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '7d87a92f7d924a8593c22822680cf022,en:70b2c47c0507415e9f741bc4d5482408',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'yomax66', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.yomax66.xyz/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'max827454568@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/yoyomax66', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  PRISM_THEME_PREFIX_PATH:
    ...
    'https://npm.elemecdn.com/prism-themes/themes/prism-coldark-cold.min.css', // 代码块默认主题
  PRISM_THEME_SWITCH: process.env.NEXT_PUBLIC_PRISM_THEME_SWITCH || true, // 是否开启浅色/深色模式代码主题切换； 开启后将显示以下两个主题
  PRISM_THEME_LIGHT_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH ||
    'https://npm.elemecdn.com/prism-themes/themes/prism-coldark-cold.min.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH ||
    'https://npm.elemecdn.com/prism-themes/themes/prism-lucario.css', // 深色模式主题
